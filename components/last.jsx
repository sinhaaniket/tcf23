...
function Last(){
    return(<>
    <div className="flex flex-col justify-center items-center bg-fuchsia-800 w-full">
...
<img src="/ArrowL.png" alt="" className="w-16 h-16 cursor-pointer"/>
...
<img src="/ArrowR.png" alt="" className="w-16 h-16 cursor-pointer"/>
</div>
    </div>
    <div className="flex bg-fuchsia-800 justify-center items-center">
    <img src="/dp.png" alt="" className="w-16 h-16 py-1 cursor-pointer"/>

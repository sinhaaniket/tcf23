...
talks by industry experts. Don’t miss this opportunity to learn from the best.
      ...
      <div className="bg-gradient-to-br from-violet-950 to-fuchsia-950 flex md:flex-row flex-col justify-center md:w-screen h-fit w-screen py-12 overflow-x-hidden">

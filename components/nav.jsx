        ...
        <div>
            ...
            {open ? (
               <div className="md:hidden">
                <div className=" pt-2 pb-3 space-y-1 sm:px-3 text-white ml-4 bg-transparent w-screen bg-black absolute items-center flex flex-col justify-around top-0 h-1/2 z-20 text-center">
